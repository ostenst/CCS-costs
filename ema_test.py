...
if __name__ == "__main__":
    ...
    results = perform_experiments(lake_model, n_scenarios, n_policies, uncertainty_sampling = Samplers.LHS, lever_sampling = Samplers.LHS)
    # with MultiprocessingEvaluator(lake_model) as evaluator:
    #     results = evaluator.perform_experiments(n_scenarios, n_policies, lever_sampling=Samplers.MC)
    ...
    sns.pairplot(data, hue="policy", vars=list(outcomes.keys())) #then color the outcomes based on their policy! cool
    # print(experiments)
    # sns.scatterplot(data=experiments, x="b", y="delta", hue='policy')
    # experiments["max_P"] = df_outcomes["max_P"]
    
    # print(experiments)
    # scatter = sns.scatterplot(experiments, x="b", y="delta", c=experiments['max_P'], cmap = "viridis")
    # sns.colorbar(label='Color Variable')
    print("I am unable to plot this scatter >:( ... but it should be easy")
